document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        function validateField(field) {
            ...
            } else if (field.tagName === 'TEXTAREA' && field.hasAttribute('minlength') && value !== '') {
        ...
        contactForm.addEventListener('input', function(e) {
            ...
            if (field && (field.type === 'email' || field.type === 'tel' || field.tagName === 'TEXTAREA')) {
        ...
        contactForm.addEventListener('blur', function(e) {
            const field = e.target.closest('input, textarea, select');
            if (field && (field.hasAttribute('required') || field.type === 'email' || field.type === 'tel')) {
                validateField(field);
            }
        }, true);
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '2ae38524-2ccf-4e07-bfd4-242710acb290',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '2ae38524-2ccf-4e07-bfd4-242710acb290';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '2ae38524-2ccf-4e07-bfd4-242710acb290';
